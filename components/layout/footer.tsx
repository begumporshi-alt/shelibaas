        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm leading-relaxed text-white/50 max-w-xs">
              <EditableText
                ...
                fallback="Bangladesh's premium curated fashion gallery. Handpicked designer wear, luxury pret, sarees, and everyday elegance — all in one destination."
                as="span"
              />
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><Link href="/shop/three-piece" className="hover:text-gold-500 transition-colors">Three Piece</Link></li>
