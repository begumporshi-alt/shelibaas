      ...
      <div className="container-luxury relative z-10">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <EditableText
            ...
            fallback="We curate, you discover. Every piece in our gallery is handpicked from designers and brands we trust — for quality, for character, for you."
            as="h2"
            multiline
        ...
        >
          {[
            ...
            { num: '40+', label: 'Trusted Designers' },
