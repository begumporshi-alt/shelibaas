        ...
        {mobileOpen && (
          ...
          >
            <motion.div
              ...
              exit={{ y: -20, opacity: 0 }}
              className="absolute top-0 left-0 right-0 bg-background/95 backdrop-blur-xl pt-24 pb-8 px-6 border-b border-border shadow-xl"
            >
              <div className="flex flex-col gap-1">
                ...
                {user && <Link href="/wishlist" className="block py-3 text-lg font-medium text-foreground border-b border-border/50">Wishlist</Link>}
                {isAdmin && <Link href="/admin" className="block py-3 text-lg font-medium text-gold-500 border-b border-border/50">Admin Dashboard</Link>}
                <Link href="/about" className="block py-3 text-lg font-medium text-foreground border-b border-border/50">About</Link>
            ...
            <div className="max-w-2xl mx-auto">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-transparent border-b border-white/20 text-white text-2xl pl-10 pr-12 py-4 focus:outline-none focus:border-gold-500 transition-colors placeholder:text-white/30"
                />
                ...
                <div className="mt-6 space-y-1">
                  {results.map((r, i) => (
                    ...
                    >
                      ...
                      <p className="text-gold-500 text-sm font-medium shrink-0">{formatBDT(r.price)}</p>
                    </Link>
                  ))}
                </div>
              )}
